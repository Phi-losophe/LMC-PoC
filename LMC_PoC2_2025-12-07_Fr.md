Voici le document remis en forme proprement (format Markdown standard), avec les équations mathématiques corrigées en LaTeX et les blocs de code structurés. J'ai également intégré les balises pour les diagrammes aux endroits appropriés.
